...
EXTENSION_NAME=LITEGEO
EXTENSION_FLAGS=\
-DDUCKDB_EXTENSION_NAMES="litegeo" \
...
#### Main build
# For regular CLI build, we link the litegeo extension directly into the DuckDB executable
...
#### Client tests
DEBUG_EXT_PATH='$(PROJ_DIR)build/debug/extension/litegeo/litegeo.duckdb_extension'
RELEASE_EXT_PATH='$(PROJ_DIR)build/release/extension/litegeo/litegeo.duckdb_extension'
